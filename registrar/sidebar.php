...
if ($sidebarCurrentPage === 'preregistrations.php') {
    $sidebarActiveKey = 'preregistrations';
} elseif ($sidebarCurrentPage === 'locked_vs_preregistered.php') {
    $sidebarActiveKey = 'locked_vs_preregistered';
}
?>
...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  <div class="app-brand demo">
    <a href="index.php" class="app-brand-link">
      ...
      <span class="app-brand-text demo menu-text fw-bolder ms-2">Registrar</span>
    </a>
  ...
  <ul class="menu-inner py-1">
    <li class="menu-header small text-uppercase mt-1">
      <span class="menu-header-text">Registrar</span>
    </li>
    <li class="menu-item px-2">
      ...
      >
        ...
        <div class="sidebar-action-content">
          ...
          <small class="sidebar-action-sub">Pre-registration analytics and ETG trends</small>
        </div>
      </a>
    </li>
    <li class="menu-item px-2">
      ...
      >
        ...
        <div class="sidebar-action-content">
          <div class="sidebar-action-title">Pre-Registered Students</div>
          <small class="sidebar-action-sub">Submitted students for registrar review</small>
        </div>
      </a>
    </li>
    <li class="menu-item px-2">
      <a
        href="locked_vs_preregistered.php"
        class="menu-link sidebar-action-card<?= $sidebarActiveKey === 'locked_vs_preregistered' ? ' active' : ''; ?>"
      >
        <span class="sidebar-action-icon bg-label-warning">
          <i class="bx bx-user-check"></i>
        </span>
        <div class="sidebar-action-content">
          <div class="sidebar-action-title">Locked vs Pre-Registered</div>
          <small class="sidebar-action-sub">Find locked students still needing contact</small>
        </div>
      </a>
    </li>
  </ul>
