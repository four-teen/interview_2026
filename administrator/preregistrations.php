...
>
  <head>
    ...
    <style>
      ...
      .prg-print-section + .prg-print-section {
        margin-top: 1.4rem;
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="prg-print-sheet">
                <div class="prg-print-header">
                  ...
                  <div class="prg-print-title"><?= htmlspecialchars((string) ($printHeader['report_title'] ?? 'Pre-Registered Students')); ?></div>
                ...
                <?php else: ?>
                  <?php foreach ($printSections as $section): ?>
                    <section class="prg-print-section">
                      <div class="prg-print-program">
                        <?= htmlspecialchars((string) ($section['program_label'] ?? 'No Program')); ?>
                        <span class="prg-print-count">(<?= number_format(count((array) ($section['rows'] ?? []))); ?> students)</span>
                      </div>
                      <ol class="prg-print-list">
                        <?php foreach (($section['rows'] ?? []) as $printRow): ?>
                          <li>
                            <span class="prg-print-list-name"><?= htmlspecialchars((string) ($printRow['full_name'] ?? 'Unknown Student')); ?></span>
                            <span class="prg-print-list-meta">
