...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  <div class="app-brand demo">
    <a href="index.php" class="app-brand-link">
      ...
      <span class="app-brand-text demo menu-text fw-bolder ms-2">Guidance</span>
    </a>
    ...
    <li class="menu-item px-2">
      ...
      >
        ...
        <div class="sidebar-action-content">
          ...
          <small class="sidebar-action-sub">Scored and unscored student snapshot</small>
        </div>
      </a>
    </li>
    <li class="menu-item px-2">
      ...
      >
        ...
        <div class="sidebar-action-content">
          <div class="sidebar-action-title">Student Information</div>
          <small class="sidebar-action-sub">Add, update, and review placement records</small>
        </div>
      </a>
    </li>
  </ul>
